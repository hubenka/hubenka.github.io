...
1. Vypíš si heslovite najdôležitejšie informácie o osobnosti informatiky. Bližie si prečítaj o jednej z týchto osobností: Alan Turing, Charles Babbage, Ada Lovelace, Tim Berners-Lee, John von Neumann. Využi online encyklopédiu, napr. Wikipedia alebo Britannica. Tvoje poznámky budú zachytávať:
	- dátum a miesto narodenia, prípadne dátum a miesto úmrtia
	- školy, ktoré absolvovali a kedy ich študovali
...
1. Nájdi trasu pešo a na bicykli z nášho gymnázia ku štrkovisku Zlaté Piesky. Koľko cesta trvá a ako je to ďaleko? Akú z ponúkaných ciest využiješ? Ktorý mapový plánovač je najlepší? Využi plánovače cesty v mapách, napr.: 
	- [mapy.com](https://mapy.com/)
	- [openstreetmap.org](https://www.openstreetmap.org/)
	- [maps.google.sk](https://www.google.com/maps/)
	- [bing.com/maps](https://www.bing.com/maps)
	- [maps.apple.com](https://maps.apple.com/)
2. Preskúmaj Bratislavu na historických mapách: [StaréMapy.sk](https://www.staremapy.sk), [Historická ortofotomapa SR](https://mapy.tuzvo.sk/HOFM/). Zodpovedz na otázky, ktoré máme ako bádatelia dejín mesta:
	- Aké rôzne názvy malo Námestie SNP v Bratislave od roku 1900?
	- Kedy bola postavená Bajkalská ulica v Bratislave?
3. Nájdi vlastníkov uvedených miest na katastrálnej mape: [zbgis](https://zbgis.skgeodesy.sk/mkzbgis/sk/kataster)
	- Obchodné centrum Eurovea
	- Veľký Draždiak
	- Dóm sv. Martina
...
1. Nájdi spojenie mestskej hromadnej dopravy zo železničnej stanice Bratislava-Nové Mesto na Hrad Devín v sobotu o 10:00. Koľko trvá cesta, kade budeš cestovať a aké linky použiješ? Over si obmedzenia na trase.
2. Nájdi vlakové spojenie z Bratislavy do Brezna o mesiac v pondelok. Kedy budeš vyrážať, aká dlhá bude cesta, kde budeš prestupovať, aké dlhé sú prestupy a koľko bude stáť lístok, keby cestuješ aj s rodičom?
3. Porovnaj výhodnosť vlakového oproti leteckému spojenia z Bratislavy do Hamburgu v Nemecku.


## D. Lingvistické informácie

1. Zisti 3 synonymá k slovu: "ruch", 
	- Slovníkový portál Jazykovedného ústavu Ľ. Štúra SAV: [slovniky.korpus.sk](https://slovnik.juls.savba.sk/)
2. Prelož pomocou online slovníka do angličtiny slova "lesk" a nájdi k nemu 3 anglické synonymá:
