...
V textovom súbore (jedla.txt) sú uložené informácie o označených jedlách v školskej jedálni na nasledujúci deň. Výber jedla reprezentuje jeden znak označujúci farebné označenie
...
3. Vytvorí nový textový súbor s názvom suhrn.txt, kde budú uvedené počty jednotlivých jedál.
4. Vykreslí vhodný graf na vizualizáciu celkového počtu jedál.
...
Nápoveď: [Znakové reťazce v Pythone](https://python2016-sphinx.readthedocs.io/sk/latest/06.html)
